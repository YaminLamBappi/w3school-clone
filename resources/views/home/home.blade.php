...
<head>
    ...
    <!-- <link rel="stylesheet" href="{{ asset('dist/css/navbarslide.css')}}"> -->
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <!-- Navbar -->
        <nav class="main-header sticky-top navbar navbar-expand navbar-white">
            <!-- Left navbar links -->
            <div id="scroll-left-btn" class="scroll-btn" onclick="scrollNavbar(-1)">❮</div>
    ...
    <script src="{{ asset('dist/js/navbar.js') }}"></script>
